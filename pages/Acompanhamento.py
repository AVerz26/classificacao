...
x = pd.merge(filtered_df, contagem_itens, left_on='Número do Item', right_on='Item', how='right')
...
filtered_df.drop(['Item_x', 'Date', 'Quantidade', 'Número do Item', 'Descrição', 'Situação'], axis=1, inplace=True)
